...
CHECKPOINT = "/home/alexandre/logs/SimpleMLP11aout/163feat-conditioning-5_hidden/version_0/checkpoints/epoch=22-step=32108.ckpt"
...
SAVE_PATH = pathlib.Path('/home/alexandre/Music/perceptual_exp/mlp/163feat-conditioning-5_hidden')
...
with open("/home/alexandre/logs/SimpleMLP11aout/163feat-conditioning-5_hidden/scaler.pkl", 'rb') as f:
    scaler = pickle.load(f)

model = SimpleMLP.load_from_checkpoint(CHECKPOINT, num_features=163, hidden_size=100,
                                       num_hidden_layers=5,
...
datamodule = FeaturesDataModule(CLEAN_PATH, IN_DOMAIN_PATH, PROCESSED_PATH, seed=25,
                                ...
                                batch_size=128, return_file_name=True, out_csv_name='data_full.csv',
                                clf_feat=True, fx_feat=False
                                )
datamodule.setup()
...
if WRITE_AUDIO:
    ...
    pred = model.forward(feat, conditioning=conditioning)
